...
<h1>Filtra y encuentra los eventos</h1>
<br>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'columns'=>array(
				...
				array(
						...
						'name'=>'fecha_ini',
						'filter'=>"<input type='date' name='Semana[fecha_ini]' min='2016-05-17' max='2016-05-22' value='".$model->fecha_ini."'>",
				...
				array(
						...
						'name'=>'fecha_fin',
						'filter'=>"<input type='date' name='Semana[fecha_fin]' min='2016-05-17' max='2016-05-22' value='".$model->fecha_fin."'>",
