...
<?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'columns'=>array(
				...
				array(
						...
						'name'=>'fecha_ini',
						'filter'=>"<input type='date' name='Semana[fecha_ini]' min='2017-05-22' max='2017-05-27' value='".$model->fecha_ini."'>",
				...
				array(
						...
						'name'=>'fecha_fin',
						'filter'=>"<input type='date' name='Semana[fecha_fin]' min='2017-05-22' max='2017-05-27' value='".$model->fecha_fin."'>",
